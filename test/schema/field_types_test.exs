defmodule DealcloudTest.Schema.FieldTypesTest do
  use ExUnit.Case, async: true

  alias Dealcloud.Impl.Schema.FieldTypes, as: Request
  ...
  test "request with correct method and path", %{bypass: bypass} do
    Bypass.expect(bypass, fn conn ->
      ...
      assert "/api/rest/v4/schema/fieldtypes" == conn.request_path
